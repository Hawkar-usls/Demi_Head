...
EXPECTED_TERMINAL_SCRIPT_SHA256 = "cf8f08fa565c0f0f7cc8691216095d122a0a29a7d3ba6210ea9c580f58534c12"
EXPECTED_TERMINAL_SAFETY_SHA256 = "542ee72aea113c02f724d32a2c599d1da72db7073cd7dfcc7538ecdb10b4ac7e"
EXPECTED_GATE_SCRIPT_SHA256 = "2088f86d5103c373521dd15341593a729edac5bb58a4363631a04865276cb3d1"
EXPECTED_GATE_SAFETY_SHA256 = "837ff5a19c508c1879a942e918d15eeb6585c941f37f151f7bc96299183e2420"
...
V15_ROOT = Path("habitat/nohand/v1_5")
...
def configure_v15_namespace() -> None:
    core.INBOX = V15_ROOT / "inbox"
    core.OUTBOX = V15_ROOT / "outbox"
    core.OUTCOMES = V15_ROOT / "outcomes"
    core.SETTLED = V15_ROOT / "settled"
    core.SNAPSHOTS = V15_ROOT / "state" / "snapshots"
...
def self_test() -> dict[str, Any]:
    ...
    return {
        ...
        "checks": {
            ...
            "registry_passage_read_only": True,
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Pinned DemiHead peer guard for JANUS NOHAND v1.5 registry-passage Gate-Terminal pair.")
