...
EXPECTED_TERMINAL_SCRIPT_SHA256 = "dbdff7500220b39aada6ef5571576a3c2fc0ca8e8039d18d97215ee6bcff8f4c"
EXPECTED_TERMINAL_SAFETY_SHA256 = "72c952764914332e9ee2f40f06dd6f0d5e32ddbea8c5addeb842dd78812d60ce"
...
V12_ROOT = Path("habitat/nohand/v1_2")
...
def configure_v12_namespace() -> None:
    core.INBOX = V12_ROOT / "inbox"
    core.OUTBOX = V12_ROOT / "outbox"
    core.OUTCOMES = V12_ROOT / "outcomes"
    core.SETTLED = V12_ROOT / "settled"
    core.SNAPSHOTS = V12_ROOT / "state" / "snapshots"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Pinned DemiHead peer guard for JANUS NAS NOHAND v1.2.")
