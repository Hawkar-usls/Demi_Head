...
EXPECTED_TERMINAL_SCRIPT_SHA256 = "3ee6137b3192e01b7ec96f77d8cb7c5587b73296d77e8e323e9b3e7ffdd1b041"
EXPECTED_TERMINAL_SAFETY_SHA256 = "241bade80c4b53786c61c5bd5ebfaea8d45360d9e58f50fc2969b97b0cf4df1e"
...
V13_ROOT = Path("habitat/nohand/v1_3")
...
def configure_v13_namespace() -> None:
    core.INBOX = V13_ROOT / "inbox"
    core.OUTBOX = V13_ROOT / "outbox"
    core.OUTCOMES = V13_ROOT / "outcomes"
    core.SETTLED = V13_ROOT / "settled"
    core.SNAPSHOTS = V13_ROOT / "state" / "snapshots"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Pinned DemiHead peer guard for JANUS NAS NOHAND v1.3.")
