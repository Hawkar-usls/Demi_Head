...
EXPECTED_TERMINAL_SCRIPT_SHA256 = "7afd155eb56a3233467544bd3dbbcab574d93bef85e68e0a64c3461ace7a3e75"
EXPECTED_TERMINAL_SAFETY_SHA256 = "36a39094325616720dc89aaa2652671e1c8d1edd4c414fdf27ffb5454418fd3c"
...
V141_ROOT = Path("habitat/nohand/v1_4_1")
...
def configure_v141_namespace() -> None:
    core.INBOX = V141_ROOT / "inbox"
    core.OUTBOX = V141_ROOT / "outbox"
    core.OUTCOMES = V141_ROOT / "outcomes"
    core.SETTLED = V141_ROOT / "settled"
    core.SNAPSHOTS = V141_ROOT / "state" / "snapshots"
...
def self_test() -> dict[str, Any]:
    ...
    request: dict[str, Any] = {
        ...
        "request_id": "v141-guard-selftest",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Pinned DemiHead peer guard for JANUS NAS NOHAND v1.4.1 Gate-Terminal pair.")
