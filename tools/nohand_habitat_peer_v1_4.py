...
EXPECTED_TERMINAL_SCRIPT_SHA256 = "84fd9aaa8459399c7f616495b8b4006e77e71cd7163c6695d120310ae63f8932"
EXPECTED_TERMINAL_SAFETY_SHA256 = "24e378fa0612be9f4db20c9b39c3748e97a150c47829ae19d5eae241fe6f969b"
...
V14_ROOT = Path("habitat/nohand/v1_4")
...
def configure_v14_namespace() -> None:
    core.INBOX = V14_ROOT / "inbox"
    core.OUTBOX = V14_ROOT / "outbox"
    core.OUTCOMES = V14_ROOT / "outcomes"
    core.SETTLED = V14_ROOT / "settled"
    core.SNAPSHOTS = V14_ROOT / "state" / "snapshots"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Pinned DemiHead peer guard for JANUS NAS NOHAND v1.4 Gate-Terminal pair.")
